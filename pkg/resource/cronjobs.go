...
// NewDBClusterBackupCronJob Returns the CronJob object for the Database Cluster Backup
func NewDBClusterBackupCronJob(bkp *v1alpha1.Backup, cluster *v1alpha1.MariaDBCluster, hostname string, scheme *runtime.Scheme) *v1beta1.CronJob {
	...
	cron := &v1beta1.CronJob{
		ObjectMeta: v1.ObjectMeta{
			Name:      bkp.Name,
			Namespace: bkp.Namespace,
			Labels:    utils.MariaDBClusterLabels(cluster, "mariadb-cluster-backup-cron"),
		},
		Spec: v1beta1.CronJobSpec{
			Schedule: bkp.Spec.Schedule,
			JobTemplate: v1beta1.JobTemplateSpec{
