...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &mariadbv1alpha1.MariaDBCluster{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMariaDBCluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set MariaDBCluster instance as the owner and controller
...
func newPodForCR(cr *mariadbv1alpha1.MariaDBCluster) *corev1.Pod {
